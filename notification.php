    ...
    <table>
        <thead>
          <tr>
              ...
              <th class="waves-light amber darken-4" font-style="Verdana">From</th>
              <th class="waves-light amber darken-4" font-style="Verdana">Description</th>
        	...
        	<?php 
        		...
        		while ($row = mysqli_fetch_array($result,true)) {
        			echo "
            		  ...
            		  <td ></td>
             		  <td class='white-text'>Admin</td>
             		  <td class='orange-text'>".$row['message']."</td>
          			  </tr>			

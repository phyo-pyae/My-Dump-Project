...
<div style='width:50%;margin:0 auto;'>    
     <div class="row">
    <form action="feedbackprocess.php" method="get" class="centered">
      <h4 class="header center teal-text">Give FeedBack</h4>
    <br><br>

    <textarea class="orange-text"name="text"></textarea><br><br><br>
    <input value="FeedBack" class="btn-large waves-effect waves-light amber darken-4" type="submit" name="feedback">

...
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.12152" type="text/javascript"></script>
...
<body>
<form class="jotform-form" action="https://pci.jotform.com/submit/92037433639864" method="post" name="form_92037433639864" id="92037433639864" accept-charset="utf-8">
  <input type="hidden" name="formID" value="92037433639864" />
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="92037433639864" />
  <script type="text/javascript">
  document.getElementById("si" + "mple" + "_spc").value = "92037433639864-92037433639864";
  </script>
  <div class="formFooter-heightMask" style="height:58px">
  </div>
  <div class="formFooter summer-sale-2018">
    <div class="formFooter-content">
      <a href="https://www.jotform.com/?utm_source=formfooter&utm_medium=banner&utm_term=92037433639864&utm_content=jotform_logo-ss&utm_campaign=powered_by_jotform_le" target="_blank" class="formFooter-logoLink"><img class="formFooter-logo" alt="JotForm Logo" src="https://cdn.jotfor.ms/assets/img/logo/logo-new@1x.png" /></a>
      <div class="formFooter-rightSide">
        <span class="formFooter-text">
          <div class="formFooter-text-top">
            SAVE 25%
          </div>
          <div class="formFooter-text-bottom">
            on monthly & annual plans
          </div>
        </span>
        <a class="formFooter-button" href="https://www.jotform.com/?utm_source=formfooter&utm_medium=banner&utm_term=92037433639864&utm_content=jotform_button-ss&utm_campaign=powered_by_jotform_le" target="_blank">Create your own JotForm</a>
      </div>
    </div>
  </div>
</form></body>
